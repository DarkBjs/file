...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7484144335:AAGK2nBPk4gOvwV2P9yE99YmBGUXMh91n3Q")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002199345415"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://jaychonkar57:08r9haK7qmOm8Ykg@flexgpt.err87.mongodb.net/?retryWrites=true&w=majority&appName=Flexgpt")
DB_NAME = os.environ.get("DATABASE_NAME", "Flexgpt")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002240317707"))
